...
//   }
  ...
  // console.log('seller.title',seller.personal_contact_information?.title);
    ...
    <View style={{flex: 1, backgroundColor: colors.gray}}>
      ...
      <View style={{flex: 1, paddingBottom: sheetInitialHeight}}>
        ...
        <ScrollView>
          ...
          <Formik
            initialValues={{
              title: seller.personal_contact_information?.title || 'Mr',
              first_name: seller.personal_contact_information?.first_name,
              last_name: seller.personal_contact_information?.last_name,
              company: seller.personal_contact_information?.company,
              phone_number: seller.personal_contact_information?.phone_number,
              phone_country_code: seller.personal_contact_information?.phone_country_code,
              // country : '',
              // country : 'Spain',
              // street: address.street || '',
              // house: address.house || '',
              address: seller.personal_contact_information?.address,
              address_line_2: seller.personal_contact_information?.address_line_2,
              postal_code: seller.personal_contact_information?.postal_code,
              city: seller.personal_contact_information?.city,
            }}
            ...
            //   console.log('new address',newAddress)
              setSellerProperty(constants.clothes_fields.seller.personal_contact_information, info);
              actions.resetForm();
              onDone();
            }}>
