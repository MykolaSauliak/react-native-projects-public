...
const GameNotificationsSettings = ({
    addSubscription,
    removeSubscription,
    hasPermission,
    requestPermission,
             ...
             <ScrollView>
                <View style={{flexDirection:'row', flexWrap: 'wrap',flex:1, marginTop: 30, padding: 10}}>
                        ...
                        <CheckBox
                            checkedColor="red"
                            uncheckedColor="black"
                            title='Получать уведомления о выходе тематических игр'
                            textStyle={globalStyles.text}
                            containerStyle={S.checkboxContainer}
                            // checkedIcon={<Image source={require('../checked.png')} />}
                            // uncheckedIcon={<Image source={require('../unchecked.png')} />}
                            checked={isSubscribed(Topics.games)}
                            onPress={() => toggleSubscription(Topics.games)}
                            />
                        {/* <CheckBox
                            checkedColor="red"
                            uncheckedColor="black"
