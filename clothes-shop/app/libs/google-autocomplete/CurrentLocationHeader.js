...
const CurrentLocationHeader = ({onPress, label, testID}) => (
  <Touchable onPress={onPress} style={s.card} testID={testID}>
    <View style={s.innerContainer}>
      <Icon size={24} iconName="current-location" color={colors.primary} />
