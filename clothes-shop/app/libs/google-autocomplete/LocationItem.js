...
const LocationItem = ({onPress, item, isLoading, testID, textTestID}) => (
  <Touchable onPress={() => onPress(item)} testID={testID}>
    <View style={s.container}>
      <Icon size={24} iconName="location-point" color={colors.icon} />
...
LocationItem.propTypes = {
  ...
  item: T.shape({
    ...
    structured_formatting: T.shape({
      main_text: T.string,
      main_text_matched_substrings: T.arrayOf(
        T.shape({
          length: T.number,
          offset: T.number,
        }),
